...
### [間合](mechanics.md#range) (Ma-ai)
- 0〜10の整数値で表されます。基本的には、「[前進](mechanics.md#advance)」で減り、「[後退](mechanics.md#retreat)」で増えます（達人の[間合](mechanics.md#range)い＝2は例外）。
- 多くの攻撃カードには適正[間合](mechanics.md#range)があり、その範囲内にいないと使用できません。

### ダメージ処理 (Damage Process)
攻撃が当たった時、ダメージを受ける側は「[ライフ](mechanics.md#life)」か「[オーラ](mechanics.md#aura)」のどちらで受けるかを選びます（カード効果で指定がある場合を除く）。
- [オーラ](mechanics.md#aura)受け: [オーラ](mechanics.md#aura)から[ダスト](mechanics.md#dust)へ結晶が移動します。[オーラ](mechanics.md#aura)が足りない場合、選べません（[ライフ](mechanics.md#life)受けになります）。
- [ライフ](mechanics.md#life)受け: [ライフ](mechanics.md#life)から[フレア](mechanics.md#flare)へ結晶が移動します。これが[切札](mechanics.md)の使用コストになります。

---

## 1. [眼前構築](mechanics.md#construction)のセオリー

ふるよにの醍醐味である「[眼前構築](mechanics.md#construction)」。相手の2柱を見てからデッキを組むこのフェーズで、勝負の5割が決まります。

### 相手の「最大値」を見積もる
デッキは「[通常札](mechanics.md)7枚、[切札](mechanics.md)3枚」で構築されます。このルールの中で、相手ができる「一番強い動き（ブン回り）」を想像しましょう。

- 相手のリーサルラインは？: [ユリナ](megami/01_yurina.md)なら「月影落」で6点前後、[ヒミカ](megami/03_himika.md)なら「[![フルバースト](assets/images/card/cards/na_03_o_n/na_03_o_n_4.png)](assets/images/card/cards/na_03_o_n/na_03_o_n_4.png){ .glightbox }」で5〜8点。自分がどのくらい[ライフ](mechanics.md#life)を減らされたら危険域なのかを把握します。
- 相手の防御性能は？: [トコヨ](megami/04_tokoyo.md)の「久遠ノ花」があるなら、大技は通らない前提で「細かい攻撃を重ねる」構成にする必要があります。

### 自分の「勝ち筋」を決める
漫然と「強そうなカード」を7枚選ぶのではなく、「どうやって勝つか」のシナリオを持たせます。

1.  アグロプラン: 序盤から積極的に[前進](mechanics.md#advance)・攻撃し、相手が準備を整える前に倒し切る。
2.  コントロールプラン: 相手の攻撃を[オーラ](mechanics.md#aura)受けや対応で凌ぎ、[フレア](mechanics.md#flare)を貯めて[切札](mechanics.md)の連打で逆転する。
...
基本的に、「3ターンに1回、[再構成](mechanics.md#reconstruction)（リシャッフル）が起きる」と覚えましょう。
...
- [再構成](mechanics.md#reconstruction)のコスト: 山札がない状態でカードを引く（または任意で行う）と[再構成](mechanics.md#reconstruction)が発生します。[ライフ](mechanics.md#life)に1ダメージを受け、捨て札と伏せ札を合わせて山札を作り直します。
- 伏せ札の活用: 不要なカードを伏せる（[基本動作](mechanics.md)）ことは、「次の[再構成](mechanics.md#reconstruction)を早める」行為でもあります。早くキーカードを引き込みたい時は、積極的に伏せて山札を回しましょう。

### [集中力](mechanics.md#focus)と[ライフ](mechanics.md#life)の天秤
「[纏い](mechanics.md#matoy)（[オーラ](mechanics.md#aura)回復）」や「[宿し](mechanics.md#yadoshi)（[フレア](mechanics.md#flare)獲得）」は、基本的には[集中力](mechanics.md#focus)で行うのが効率的です。
しかし、「[ライフ](mechanics.md#life)で受けるか、[オーラ](mechanics.md#aura)で受けるか」の判断は常に問われます。

- [オーラ](mechanics.md#aura)受け: 相手の追撃を防ぐために[オーラ](mechanics.md#aura)を保つ。しかし、[オーラ](mechanics.md#aura)が空になると、小さな攻撃（2/1など）が[ライフ](mechanics.md#life)に直撃します。
- [ライフ](mechanics.md#life)受け: あえて[ライフ](mechanics.md#life)で受けて[フレア](mechanics.md#flare)を貯める（[宿し](mechanics.md#yadoshi)）。「肉を切らせて骨を断つ」戦法ですが、リーサル計算を誤ると即死します。

中級者の目安: [ライフ](mechanics.md#life)が4〜5になったら、いつ死んでもおかしくありません。ここからは徹底して[オーラ](mechanics.md#aura)を維持し、[決死](mechanics.md#kesshi)の覚悟で防御しましょう。
...
### 対応不可のタイミング
相手が「[集中力](mechanics.md#focus)が0」で「手札が0〜1枚」の時、相手は全力で攻撃してきているため、防御（対応）手段を持っていない可能性が高いです。
...
### 1. 勝利の定義：[ライフ](mechanics.md#life)を0にする

このゲームの唯一の目標は、相手の**[ライフ](mechanics.md#life)を0**にすることです。
しかし、漫然と攻撃を振るだけでは勝てません。[ライフ](mechanics.md#life)を減らすには以下の2つのルートを意識する必要があります。

-   **攻撃による[ライフ](mechanics.md#life)ダメージ**: 攻撃カードの右側の数値（X/**Y**）で[ライフ](mechanics.md#life)を削る。
-   **[再構成](mechanics.md#reconstruction)ダメージ**: 相手が山札を引き切り、[再構成](mechanics.md#reconstruction)を行うたびに受ける1ダメージ。

#### 勘所：リーサル計算
相手の[ライフ](mechanics.md#life)が残り3〜4点になった瞬間が「勝負所」です。自分の手札、[集中力](mechanics.md#focus)、そして[フレア](mechanics.md#flare)（[切札](mechanics.md)）で、今この瞬間に[ライフ](mechanics.md#life)を削りきれるか（リーサル）を常に計算してください。
...
#### リソース・ループ
1.  **[オーラ](mechanics.md#aura)を削る**: 攻撃を[オーラ](mechanics.md#aura)で受けさせ、結晶を[ダスト](mechanics.md#dust)へ送る。
2.  **[ライフ](mechanics.md#life)を削る**: [オーラ](mechanics.md#aura)がない、あるいは防ぎきれない攻撃を[ライフ](mechanics.md#life)で受けさせ、結晶を[フレア](mechanics.md#flare)へ送る。
3.  **[フレア](mechanics.md#flare)を活用する**: [ライフ](mechanics.md#life)受けで得た[フレア](mechanics.md#flare)をコストに、強力な**[切札](mechanics.md)**を放つ。

#### 勘所：ダメージ選択のジレンマ
攻撃を受けた際、「[オーラ](mechanics.md#aura)で受けるか[ライフ](mechanics.md#life)で受けるか」の選択が勝敗を分けます。
-   **[オーラ](mechanics.md#aura)受け**: 次の攻撃を防ぐ盾を維持するが、[フレア](mechanics.md#flare)は増えない。
-   **[ライフ](mechanics.md#life)受け**: [フレア](mechanics.md#flare)が増えて[切札](mechanics.md)が使えるようになるが、[ライフ](mechanics.md#life)が減り、敗北に近づく。

> [!IMPORTANT]
> **「あえて[ライフ](mechanics.md#life)で受けて、返しのターンに[切札](mechanics.md)で仕留める」**という判断が、中級者への第一歩です。

---

### 3. 距離の支配：[間合](mechanics.md#range)の管理

[間合](mechanics.md#range)は単なる数字ではなく、**そのメガミの「射程圏」**を表します。

-   **得意[間合](mechanics.md#range)を維持する**: 自分の強力な攻撃カードが使える距離（例：[ユリナ](megami/01_yurina.md)なら3-4、[ヒミカ](megami/03_himika.md)なら5-10）をキープします。
-   **相手の得意[間合](mechanics.md#range)から逃げる**: 相手が攻撃できない距離へ、[基本動作](mechanics.md)（[後退](mechanics.md#retreat)・[纏い](mechanics.md#matoy)・[前進](mechanics.md#advance)）で移動します。
...
#### 序盤：準備と牽制（1〜2巡目）
-   **[宿し](mechanics.md#yadoshi)**で[フレア](mechanics.md#flare)を最低限確保する。
-   相手の[オーラ](mechanics.md#aura)を適度に削り、[ダスト](mechanics.md#dust)を作る（自分の**[纏い](mechanics.md#matoy)**のため）。
-   手札を整え、強力なコンボが打てる準備をする。

#### 中盤：リソースの削り合い（[ライフ](mechanics.md#life) 7〜4）
-   互いに[ライフ](mechanics.md#life)を削り、[切札](mechanics.md)が使用可能になる。
-   [対応](mechanics.md)カードを構え、相手の大技を警戒する。

#### 終盤：リーサルの攻防（[ライフ](mechanics.md#life) 3以下）
-   [オーラ](mechanics.md#aura)を5（上限）に保ち、[ライフ](mechanics.md#life)への致命傷を防ぐ。
-   **[再構成](mechanics.md#reconstruction)ダメージ**を考慮し、あえて[再構成](mechanics.md#reconstruction)せずに戦う判断も必要。
-   リソースを全て使い切り、相手の[ライフ](mechanics.md#life)を0に叩き込む。
...
- [ ] 無駄な「[前進](mechanics.md#advance)」で、相手が得意な近距離に飛び込んでいないか？
- [ ] [フレア](mechanics.md#flare)は足りているか？ [宿し](mechanics.md#yadoshi)すぎで[オーラ](mechanics.md#aura)がスカスカになっていないか？
...
- **3柱の傾向 (Complete)**:
    - [ハガネ](megami/08_hagane.md) (Hammer) や [アキナ](megami/23_akina.md) (Abacus) を含めた「グッドスタッフ」構成が主流。
    - 特定のギミックに特化するよりも、カードパワーの高いメガミを組み合わせ、対応力で押し切る構築が結果を残しています。

#### 環境のカウンター & 注目株

- **[ミズキ](megami/18_mizuki.md) (Helm)**:
    - Tier 1 ([サリヤ](megami/11_sariya.md)・[シスイ](megami/24_shisui.md)等) に対する明確な回答。
...
| メトリクス項目 | 内容・動向 |
| :--- | :--- |
| **規制の影響** | 銃鎌の「レッドバレット」規制は継続中ですが、[ヒミカ](megami/03_himika.md)自体の採用率は依然高水準です。 |
| **メタの流動** | S10-2への移行に伴い、[ハガネ](megami/08_hagane.md)/[サリヤ](megami/11_sariya.md)中心の環境から、より多様な「3柱目」の模索が始まっています。 |
...
</div><details><summary>[ユリナ](megami/01_yurina.md) Cards</summary>
<div class="grid cards" markdown>
...
<details><summary>[サイネ](megami/02_saine.md) Cards</summary>
<div class="grid cards" markdown>
...
<details><summary>[トコヨ](megami/04_tokoyo.md) Cards</summary>
<div class="grid cards" markdown>
...
</div><details><summary>[サイネ](megami/02_saine.md) Cards</summary>
<div class="grid cards" markdown>
...
</div><details><summary>[ヒミカ](megami/03_himika.md) Cards</summary>
<div class="grid cards" markdown>
...
<details><summary>[ヒミカ](megami/03_himika.md) Cards</summary>
<div class="grid cards" markdown>
...
<details><summary>[オボロ](megami/05_oboro.md) Cards</summary>
<div class="grid cards" markdown>
...
</div><details><summary>[オボロ](megami/05_oboro.md) Cards</summary>
<div class="grid cards" markdown>
...
<details><summary>[ユキヒ](megami/06_yukihi.md) Cards</summary>
<div class="grid cards" markdown>
...
<details><summary>[シンラ](megami/07_shinra.md) Cards</summary>
<div class="grid cards" markdown>
...
#### 10. 刀騎（[ユリナ](megami/01_yurina.md)／[サリヤ](megami/11_sariya.md)）
[サリヤ](megami/11_sariya.md)の「[騎動](mechanics.md#ride)」で[間合](mechanics.md#range)を一気に詰め、[ユリナ](megami/01_yurina.md)の重い一撃を叩き込むアグロ〜ミッドレンジ構成です。機動力と破壊力を兼ね備えています。

#### 10. 爪忍（[ライラ](megami/12_laila.md)／[オボロ](megami/05_oboro.md)）
[オボロ](megami/05_oboro.md)の手数の多さ（[設置](mechanics.md#setchi)攻撃など）で[ライラ](megami/12_laila.md)の[帯電](mechanics.md#electrify)ゲージを高速で溜め、後半に圧倒的な火力で押し切るコンボ色の強いビートダウンです。

#### 11. [毒](mechanics.md#poison)氷（[チカゲ](megami/09_chikage.md)／[コルヌ](megami/15_korunu.md)）
[毒](mechanics.md#poison)で手札を封じ、[凍結](mechanics.md#freeze)で[オーラ](mechanics.md#aura)を封じる「完全ロック」を狙います。ハマれば相手は何もできずに窒息しますが、自身の火力が低めな点が課題です。

#### 12. [毒](mechanics.md#poison)鏡（[チカゲ](megami/09_chikage.md)／[ヤツハ](megami/16_yatsuha.md)）
[ヤツハ](megami/16_yatsuha.md)の『[寄花](megami/cards.md#yatsuha)』と[チカゲ](megami/09_chikage.md)の『[毒霧](megami/cards.md#chikage)』を組み合わせ、高速で山札を汚染するコントロール型です。
相手の山札を[毒](mechanics.md#poison)で死滅させ、[ヤツハ](megami/16_yatsuha.md)の自傷ダメージを最小限に抑えながら、相手のリソースを根こそぎ奪い取ります。
