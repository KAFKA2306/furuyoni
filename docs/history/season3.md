...
シーズン3は、本作の歴史において「最も多様性が花開いた黄金期」の一つとして語り継がれています。**[チカゲ](../megami/09_chikage.md)（[毒](../rules.md#poison)）**、**[クルル](../megami/10_kururu.md)（[機巧](../rules.md#mechanism)）**、**[シンラ](../megami/07_shinra.md)（書）**、**[サリヤ](../megami/11_sariya.md)（騎）**といった、極めてユニークなギミックを持つメガミたちが立て続けに参戦し、戦略の幅は爆発的に広がりました。

「[毒](../rules.md#poison)による妨害」「[機巧](../rules.md#mechanism)によるループ」「書による言論統制」「騎による超高速移動」。これら四者四様の個性が、これまでの「[間合](../rules.md#range)による殴り合い」という基本に、さらに深いゲーム性を加えました。
...
**妨害と手数の重なり**
- **戦略**: 相手の手札を[毒](../rules.md#poison)で縛りつつ、[オボロ](../megami/05_oboro.md)の[設置](../rules.md#setchi)攻撃で[ライフ](../rules.md#life)を削る。
- **評価**: 相手のリソースを腐らせることに特化した、極めて嫌らしい、しかし洗練されたアグロデッキとして君臨しました。

---

## 4. 歴史的教訓：『達人の[間合](../rules.md#range)』の導入

シーズン3の中盤から終盤にかけて、極端な遠距離ロックや[機巧](../rules.md#mechanism)を用いた「無限ループ」的な動きへの対策として、ゲームの根幹に関わる調整（《達人の[間合](../rules.md#range)》の再定義など）が議論され始めました。これが、次世代の「シーズン4」の設計思想へ直結することになります。
