...
*   **斬 (ユリナ)**: 基本攻撃。間合3-4。
*   **一閃 (ユリナ)**: 高火力攻撃。間合3。
*   **柄打ち (ユリナ)**: 近距離攻撃＆移動。間合2。
*   **薙斬り (サイネ)**: 安定した中距離攻撃。間合4-5。
*   **八方振り (サイネ)**: 条件付きで強力な2回攻撃。間合4-5。
*   **見切り (サイネ)**: 対応札。相手の攻撃を避ける。
*   **圏域 (サイネ)**: 前進のためのリソース確保。
...
### 立ち回りガイド
1.  **序盤**: `圏域`などを使いながら前進し、間合4-5を目指します。`薙斬り`で牽制しましょう。
2.  **中盤**: 間合3-4に入り、`斬`や`一閃`でライフを削ります。相手の攻撃には`見切り`や`浦波嵐`で対応し、ダメージを最小限に抑えます。
3.  **終盤**: 相手のライフが残り少なくなったら、フレア（気）を消費して`月影落`を叩き込みましょう。ユリナのライフが3以下（決死）になると攻撃が強化されるので、ピンチはチャンスです。
...
*   **一閃 (ユリナ)**: 高火力攻撃。
*   **居合 (ユリナ)**: 全力攻撃。高いダメージ。
*   **梳流し (トコヨ)**: 境地（集中力2）で山札に戻る攻撃。リソース維持に役立つ。
*   **雅打ち (トコヨ)**: 対応攻撃。相手の攻撃を無効化しつつ反撃。
*   **詩舞 (トコヨ)**: 回避＆移動。
*   **要返し (トコヨ)**: 山札回復＆対応。

**切札:**
*   **月影落 (ユリナ)**: 決定打。
*   **久遠ノ花 (トコヨ)**: 最強クラスの防御＆攻撃。
*   **無窮ノ風 (トコヨ)**: 相手の手札を捨てさせる攻撃。

### 立ち回りガイド
1.  **境地**: トコヨを使う時は「集中力」を2に保つ「境地」状態を意識しましょう。これにより`梳流し`や`雅打ち`が真価を発揮します。
...
### 立ち回りガイド
1.  **間合維持**: 相手が嫌がる間合（主に4-5）を維持し続けます。`風舞台`や`見切り`で相手の得意な間合に行かせないようにします。
2.  **リソース差**: `梳流し`でコツコツ攻撃しつつ、相手の大技は`久遠ノ花`や`雅打ち`で完封します。焦って攻める必要はありません。
3.  **八相の爆発**: 相手が攻め疲れてこちらのオーラが減った時（八相状態）、`八方振り`などの強化されたカードで一気に逆転します。
...
**通常札:**
*   **シュート (ヒミカ)**: 遠距離基本攻撃。
*   **ラピッドファイア (ヒミカ)**: 連火（3枚目以降）で強力な攻撃。
*   **マグナムカノン (ヒミカ)**: 相手のライフを削る。
*   **バックステップ (ヒミカ)**: 後退しつつドロー。距離を取る要。
*   **バックドラフト (ヒミカ)**: 次の攻撃を強化＆相手のリソース縮小。
*   **詩舞 (トコヨ)**: 後退対応。
*   **風舞台 (トコヨ)**: 大幅な距離確保。

**切札:**
*   **レッドバレット (ヒミカ)**: コスト0の追撃。
*   **クリムゾンゼロ (ヒミカ)**: 最後の詰め。近距離でも戦える保険。
*   **久遠ノ花 (トコヨ)**: 近づかれた時の切り札。

### 立ち回りガイド
1.  **先制攻撃**: 初手から`シュート`や`ラピッドファイア`で攻撃します。ヒミカは「連火」により、1ターンに3枚カードを使うと強くなります。
2.  **徹底的な拒絶**: 相手が前進してきたら、`バックステップ`、`詩舞`、`風舞台`を駆使して、強引に元の遠距離（間合7-9）へ戻します。
3.  **近中距離のカバー**: もし近づかれても、トコヨの要素（`雅打ち`など）や`クリムゾンゼロ`で迎撃できるのがこのペアの強みです。
...
*   **ラピッドファイア (ヒミカ)**: 主力火力。
*   **バックステップ (ヒミカ)**: 手札調整＆移動。
*   **バックドラフト (ヒミカ)**: コンボ始動パーツ。
*   **見切り (サイネ)**: 防御。

**切札:**
*   **スカーレットイマジン (ヒミカ)**: カードを大量に引く。コンボの着火剤。
*   **レッドバレット (ヒミカ)**: 火力の底上げ。
*   **律動弧戟 (サイネ)**: 対応＆追撃。

### 立ち回りガイド
1.  **セットアップ**: 序盤は適度に攻撃しつつ、手札とフレアを整えます。`スカーレットイマジン`を使う準備をしましょう。
2.  **バーストターン**: 準備ができたら`スカーレットイマジン`発動。大量の手札から`バックドラフト`→`ラピッドファイア`→`薙斬り`など、ヒミカとサイネの攻撃を連続で叩き込みます。
3.  **レンジスイッチ**: 遠距離から始めて、カードの効果で自然と距離が縮まり、最後はサイネの`薙斬り`の間合でフィニッシュする流れるような連携を目指します。
...
*   **柄打ち (ユリナ)**: 近距離での手数。
*   **鋼糸 (オボロ)**: 設置対応攻撃。
*   **影菱 (オボロ)**: 設置でハンデス（手札破壊）＆ダメージ。
*   **忍歩 (オボロ)**: 設置で間合操作。
*   **誘導 (オボロ)**: 設置で相手のオーラを剥がす。

**切札:**
*   **月影落 (ユリナ)**: フィニッシャー。
*   **熊介 (オボロ)**: 全力攻撃。設置カードを一斉に起動。
*   **鳶影 (オボロ)**: 任意の設置カードを使用済みにできる再利用札。

### 立ち回りガイド
1.  **設置（Set）**: 手札の`鋼糸`や`影菱`を伏せて「設置」します。これで次の相手ターンや自分のターン開始時に自動的に攻撃が発動します。
2.  **誘導と月影**: `誘導`を設置しておけば、相手のオーラを強制的に剥がせます。オーラが薄くなった相手に、本命の`月影落`や`一閃`をクリーンヒットさせましょう。
3.  **必殺コンボ**: 攻撃が重なると、相手は対応しきれません。設置攻撃が発動するターンに合わせて、手札からの攻撃も重ねる「ビッグターン」を作りましょう。
...
*   **忍歩 (オボロ)**: 位置取り。
*   **しこみび/ねぐら (ユキヒ)**: 攻防の要。
*   **ふりはらい/たぐりよせ (ユキヒ)**: 間合操作。
*   **かさまわし (ユキヒ)**: 傘の開閉操作。
*   **ひきあし/もぐりこみ (ユキヒ)**: 移動。
*   **影菱 (オボロ)**: 相手への妨害。

**切札:**
*   **壬蔓 (オボロ)**: 設置カードの再利用＆コスト軽減。
*   **はらりゆき (ユキヒ)**: メイン火力。回して何度も撃つ。
*   **くるりみ (ユキヒ)**: 防御＆傘操作。

### 立ち回りガイド
1.  **傘の開閉**: ユキヒのカードは傘が開いているか閉じているかで効果が変わります。`かさまわし`などで状態を管理し、必要な効果を引き出しましょう。
...
*   **衝音晶 (サイネ)**: 対応不可攻撃。
*   **壮語 (シンラ)**: 相手の攻撃を牽制。
*   **引用 (シンラ)**: 相手の山札を伏せ札にする（デッキ破壊）。
*   **詭弁 (シンラ)**: 相手の付与札などに干渉。
*   **立論 (シンラ)**: ドロー＆プランニング。
*   **反論 (シンラ)**: 相手の攻撃を無効化。

**切札:**
*   **森羅判証 (シンラ)**: 究極の盤面支配。付与札がある限り攻撃が強化。
*   **律動弧戟 (サイネ)**: フィニッシャー。
*   **完全論破 (シンラ)**: 相手の切り札すら封じる可能性があります。

### 立ち回りガイド
1.  **論破**: `反論`や`壮語`を使って、相手のプランを崩します。相手がやりたいことをさせないことで、ペースを握ります。
2.  **森羅判証**: 切札`森羅判証`を展開すると、盤面に「付与札」があるだけでダメージが発生するようになります。サイネの`衝音晶`などの「付与」要素のある攻撃が、凶悪な確定ダメージソースに変わります。
3.  **詰み**: 相手は攻撃しても無効化され、守ろうとしても固定ダメージで削られるという「詰み」の状況を作り出しましょう。

---
**次のステップへ**:
これらすべてのペアを試した時、あなたはもう初心者ではありません。自分だけのオリジナルのペアを見つけ、眼前構築（相手を見てからデッキを組む）の深淵へと足を踏み入れましょう。
