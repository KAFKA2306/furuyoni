...
<div class="megami-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
  ...
  <div class="megami-meta">
    - 権能: 鏡
    - 難易度: ★★★★☆
    - 得意[間合](../mechanics/index.md): [相手による]
  </div>
</div>

## 本質的な解説

[ヤツハ](index.md)の本質は「自己という輪郭の喪失と、相手の力を写し取る鏡像的反射」にあります。

彼女自身は、最初は定まった形を持ちません。しかし、対峙する相手のステータス、カード、そしてその意志を「[鏡映](../mechanics/index.md)」させることで、相手の最強の武器をそのまま自分自身の力へと変換します。相手が強ければ強いほど、[ヤツハ](index.md)もまた抗いがたい強さを手に入れます。
...
相手のデッキを熟知していればいるほど、その力を逆利用する[ヤツハ](index.md)の恐ろしさは増していきます。「敵を知り、己を消す」[境地](../mechanics/index.md)が、彼女を使いこなすための条件です。
