...
<div class="megami-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
  ...
  <div class="megami-meta">
    <ul>
      ...
      <li><strong>得意[間合](../rules.md#range)</strong>: 2-6</li>
    </ul>
  </div>
</div>

!!! info "魂を震わせる、[遠心](../rules.md#enshin)力の破壊神"
    シーズン10においても、その一撃必殺のパワーは健在で、特に特定の距離から飛び込んでくるバースト火力は、全プレイヤーに「[間合](../rules.md#range)管理」の重要性を再認識させます。

## 物語の起源：ハガネ

> 「重さに勝る正義はない。……全力で振り抜く、それだけで十分だ！」

ハガネは、大地の重みと鋼の意思を[宿し](../rules.md#yadoshi)た「槌」を振るうメガミです。
...
「[遠心](../rules.md#enshin)」という力は、彼女が限界まで己を加速させ、運動エネルギーを暴力的な質量へと変換して叩きつける、小細工なしの真っ直ぐな戦闘哲学を象徴しています。

## キーワード能力: [遠心](../rules.md#enshin) (Enshin)

ハガネの攻撃の真価は、その「勢い」にあります。

*   **[遠心](../rules.md#enshin)の条件**: あなたがこのターン中に、[基本動作](../rules.md)やカード効果によって合計で**2以上の[間合](../rules.md#range)（移動）**を行っている時に発動します。
*   **効果の性質**: ダメージの劇的な増加（例：[3/2]→[5/3]）、ガード不能、リソース破壊などの超強力なバフが付加されます。
*   **戦略的意味**: ハガネのターンは「いかに効率よく2マス動いてから殴るか」というパズルになります。[宿し](../rules.md#yadoshi)や[前進](../rules.md#advance)をパズルの一部として組み込み、最大加速状態での一撃を常に狙います。
...
*   **通常時**: [3/2]
*   **[遠心](../rules.md#enshin)時**: [5/3]（※版により数値は変動しますが、概ね超強化されます）
*   **解説**:
    ハガネのすべてが詰まった一枚。[遠心](../rules.md#enshin)条件を満たした状態で放たれるこの一撃は、[ライフ](../rules.md#life)を3点削る「[通常札](../rules.md)とは思えない暴力」です。これを当てるために全力で移動し、当てた瞬間がハガネ使いの最高の多幸感となります。
...
*   **[遠心](../rules.md#enshin)時**: ヒット時、相手は[オーラ](../rules.md#aura)を[ダスト](../rules.md#dust)へ送る、あるいは手札を捨てるなどの追加効果。
*   **解説**:
    [遠心](../rules.md#enshin)撃を当てるための「前振りの一撃」。相手の[オーラ](../rules.md#aura)を削り取り、本命の5/3を通すための道を作ります。
...
*   **解説**:
    [ダスト](../rules.md#dust)から結晶を自分の[オーラ](../rules.md#aura)や[フレア](../rules.md#flare)に移動させる、あるいは盤面全体を震わせてリソースを再配置する札。ハガネの燃費の悪さを補う重要なエンジンとなります。
...
*   **解説**:
    **[遠心](../rules.md#enshin)成立のためのキーカード。**
    一気に[間合](../rules.md#range)を2動かす、あるいは自分のリソースを移動に変えることで、1アクションで[遠心](../rules.md#enshin)条件を達成させます。ハガネにとっての「ブースター」です。
...
*   **解説**:
    展開中の攻撃札にバフを与える付与札。ハガネの連撃をより重くし、相手の[オーラ](../rules.md#aura)受けを許さないプレッシャーを与え続けます。
...
*   **解説**:
    ハンマーの柄や側面で叩くようなイメージの、近距離攻撃。[遠心](../rules.md#enshin)撃が届かない至近距離（[間合](../rules.md#range)0-2など）での有効打として、クリンチしてくる相手への回答になります。
...
*   **解説**:
    相手を引き寄せる付与札。遠い[間合](../rules.md#range)いに逃げようとする相手を強制的にハガネの[間合](../rules.md#range)に引き戻し、逃げ場のない処刑場を作り出します。
...
**解説**:
地響きを鳴らし、相手の手札や[オーラ](../rules.md#aura)に震動を与えるサポート[切札](../rules.md)。
...
判定勝ちを狙う相手の喉元に突きつける、一発逆転の[ライフ](../rules.md#life)奪取力を備えています。

---

## 主要アーキタイプ

### 1. [遠心](../rules.md#enshin)超火力アグロ
**「三歩進んで、一撃で沈める。」**
...
### [ライラ](12_laila.md) (槌爪)
**「震災級のバースト力」**
共に移動や手数を武器にする最高に相性の良いペア。移動だけで[ライラ](12_laila.md)のゲージが溜まり、ハガネの[遠心](../rules.md#enshin)が成立する。一瞬の隙から[ライフ](../rules.md#life)10点を削り切る全メガミ屈指の殺傷能力。

### [サリヤ](11_sariya.md) (槌騎)
**「鋼のエンジン」**
[サリヤ](11_sariya.md)の高速移動によって、ハガネの[遠心](../rules.md#enshin)がかつてない容易さで成立。戦場を縦横無尽に駆け抜ける蹂躙ペア。
...
!!! danger "移動リソースの枯渇"
    ハガネは攻撃のために移動を必要としますが、移動（[前進](../rules.md#advance)・[後退](../rules.md#retreat)）には結晶（[オーラ](../rules.md#aura)や[ダスト](../rules.md#dust)）が必要です。
    **「[オーラ](../rules.md#aura)は移動に使うか、防御に残すか」というジレンマに常に直面します。**
    攻撃に全振して[オーラ](../rules.md#aura)0でターンを返すと、返しのワンショットで沈むリスクがあります。

!!! tip "「[遠心](../rules.md#enshin)」を見せ札にする"
    あえて1マスだけ動き、[遠心](../rules.md#enshin)を成立させないターンを作ることも重要です。
    相手は「次のターンは[遠心](../rules.md#enshin)撃が来る」と警戒して余計な[纏い](../rules.md#matoy)をしてリソースを消費します。
    その隙に[宿し](../rules.md#yadoshi)を行って[フレア](../rules.md#flare)を溜め、本命の[切札](../rules.md)を撃つ準備を整えるなど、ブラフを交えた立ち回りがハガネの奥深さです。
