...
### [トコヨ](04_tokoyo.md) (扇信頼)
**「鉄壁の投資家」**
アキナのリソース奪取とトコヨの防御性能が噛み合った非常に強力なコントロールペア。

### [ハツミ](17_hatsumi.md) (棹信頼)
**「経済的封鎖」**
アキナのリソース操作に加え、ハツミのレンジロックが加わることで相手を完全にコントロールする。ハツミの形態は、強力な『イサナ』が使用可能な**「櫂」**が推奨される。
