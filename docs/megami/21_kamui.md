...
### Phase 3: 終盤 (リーサル)
- **目的**: 『[![灯 / 暁](../assets/images/card/cards/na_21_o_s/na_21_o_s_1.png)](../assets/images/card/cards/na_21_o_s/na_21_o_s_1.png){ .glightbox }』によるリーサル。禁忌ゲージが14-15のギリギリで踏み抜くのが理想。
- **バーストコンボ例**: 
...
| :--- | :--- | :--- | :--- |
| [**紅刃**](cards.md#紅刃) | 主力削り | 禁忌+1。特定条件下でバフ。 | メイン火力。 |
| [**散華刃**](cards.md#散華刃) | リソース破壊 | 禁忌+1。相手[オーラ](../rules.md#aura)を自身の[オーラ](../rules.md#aura)へ。 | テンポ奪取の要。 |
| [**四剣乱刃**](cards.md#四剣乱刃) | 追撃 | 禁忌+1。全力で追加攻撃。 | リーサルパーツ。 |
| [**棘縫い**](cards.md#棘縫い) | 柔軟性 | [間合](../rules.md#range)に応じて効果変化。 | [レンジロック](../rules.md#range-lock)対策。 |
| [**血晶乱流**](cards.md#血晶乱流) | 万能札 | 複数の効果から2つ選択。 | 状況対応力が高い。 |
| [**斬り払い**](cards.md#斬り払い) | 対応 | 禁忌+2。ダメージ無効化。 | 緊急回避用。 |
| [**血習い**](cards.md#血習い) | 禁忌加速 | 山札回復＋禁忌進行。 | 覚醒までの時間短縮。 |
