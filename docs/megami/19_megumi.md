...
| :--- | :--- | :--- | :--- |
| [**打擲**](cards.md#打擲) | 主力攻撃 | 種結晶があれば3/2。 | メグミの魂。 |
| [**鳳仙花**](cards.md#鳳仙花) | 継続火力 | 生育1で相手ターンに2/1発生。 | テンポ維持に。 |
| [**殻打ち**](cards.md#殻打ち) | 強化/リソース | 付与札に生育を乗せる。 | コンボ의起点。 |
| [**葦**](cards.md#葦) | 位置調整 | 後退 + 種結晶使用で移動増。 | 間合制御の要。 |
| [**根張**](cards.md#根張) | 妨害 | 相手の行動を制限。 | 防御の一環。 |
