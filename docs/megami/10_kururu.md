...
<div class="megami-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
  ...
  <div class="megami-meta">
    <ul>
      ...
      <li><strong>得意[間合](../mechanics.md#range)</strong>: 1-10</li>
    </ul>
  </div>
</div>
...
「[機巧](../mechanics.md#mechanism)」という力は、彼女がバラバラの事象（カード種別）を緻密に連結させ、巨大な勝利の方程式へと組み上げていく「創造」のプロセスそのものを象徴しています。

## キーワード能力: [機巧](../mechanics.md#mechanism) (Kiko / Mechanism)

クルルの強さは、彼女の「持ち物（カード種別）」の多様性に依存します。

*   **[機巧](../mechanics.md#mechanism)の発動条件**: 自分の捨て札、使用済みの[切札](../mechanics.md)、または場にある付与札の中に、指定された**「カード種別（攻撃、行動、付与）」**や**「サブタイプ（対応、全力）」**が存在することで効果が発動します。
*   **戦略的意味**: 手札をただ使うのではなく、「どのカードを先に捨て札に送り、どの[機巧](../mechanics.md#mechanism)を起動させるか」という緻密なシーケンス（手順）構築が求められます。
...
*   **解説**:
    [機巧](../mechanics.md#mechanism)条件を満たすことで、ダメージが跳ね上がるクルルの基本攻撃。[間合](../mechanics.md#range)を選ばないため、どんな距離からでも「発明品の雷」を落とすことができます。
...
**解説**:
**クルルのロマンの結晶。**
[機巧](../mechanics.md#mechanism)条件が累積するほど威力を増し、最終的には[10/10]のような回避不能の致死ダメージを叩き出す巨大ロボット。これを発動させることこそが、多くのクルル使いの至上の喜びです。
...
**「最強の札を、無限に送る。」**
強力な[通常札](../mechanics.md)（例：[ユリナ](01_yurina.md)の『[![一閃](../assets/images/card/cards/na_01_o_n/na_01_o_n_2.png)](../assets/images/card/cards/na_01_o_n/na_01_o_n_2.png){ .glightbox }』や[ヒミカ](03_himika.md)の『[![マグナムカノン](../assets/images/card/cards/na_03_o_n/na_03_o_n_3.png)](../assets/images/card/cards/na_03_o_n/na_03_o_n_3.png){ .glightbox }』）をコピーし、毎ターン無償で叩き込み続ける。
...
*   **推奨パートナー**: 有能な[通常札](../mechanics.md)を持つ全メガミ（[ユリナ](01_yurina.md)、[ヒミカ](03_himika.md)、[ライラ](12_laila.md)等）

### 2. びっぐごーれむ降臨型 (超火力プラン)
**「パズルを解き、勝利を召喚する。」**
あらゆる[機巧](../mechanics.md#mechanism)を総動員して『びっぐごーれむ』のコストと威力をブーストし、一撃で[ライフ](../mechanics.md#life)10点を削る。

*   **基本戦術**:
    1. カードを捨て札に計画的に送り、[機巧](../mechanics.md#mechanism)条件を網羅する。
    2. [集中力](../mechanics.md#focus)とドローを管理し、最短でコストを宿す。
...
### [サリヤ](11_sariya.md) (騎絡)
**「変幻自在のモビリティ」**
共にテクニカルな要素（燃料、[機巧](../mechanics.md#mechanism)）を持つため、使いこなせば全距離で無双できる。

---

## 戦術の核心

!!! danger "「[機巧](../mechanics.md#mechanism)」の破綻は死を意味する"
    クルルはパズルのピースひとつが欠けただけで、何の効果も持たないメガミに成り下がります。
    **「相手のハンデス（手札破壊）」や「付与札の除去」に対して極めて脆弱です。**
    自分の絡繰を守るための最低限の防御手段を常に意識してください。

!!! tip "「[機巧](../mechanics.md#mechanism)」の可視化"
    熟練のクルル使いは、自分の捨て札の構成（攻撃が何枚、行動が何枚……）を完璧に把握しています。
    対戦中は、どの[機巧](../mechanics.md#mechanism)が「今」アクティブなのか、どの[機巧](../mechanics.md#mechanism)が「次」に必要か、メモを取るような感覚で整理しながら戦いましょう。
