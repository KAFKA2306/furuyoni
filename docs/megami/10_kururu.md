...
クルルの強さは、彼女の「持ち物（カード種別）」の多様性に依存します。
...
シーズン10（大[切札](../mechanics.md)時代）において、クルルは「コンボの頂点」として君臨しています。
...
**[![役割](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png)](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png){ .glightbox }**: 主力攻撃 / [機巧](../mechanics.md)の核

*   **適正[間合](../mechanics.md)**: 1-10
*   **解説**:
    [機巧](../mechanics.md)条件を満たすことで、ダメージが跳ね上がるクルルの基本攻撃。[間合](../mechanics.md)を選ばないため、どんな距離からでも「発明品の雷」を落とすことができます。
...
*   **解説**:
    カードを引き、さらに[機巧](../mechanics.md)条件に応じて追加の行動を可能にする札。クルルの複雑なコンボを回すための重要なピニオンギア（歯車）です。
...
**解説**:
**クルルのロマンの結晶。**
[機巧](../mechanics.md)条件が累積するほど威力を増し、最終的には[10/10]のような回避不能の致死ダメージを叩き出す巨大ロボット。これを発動させることこそが、多くのクルル使いの至上の喜びです。
...
**「最強の札を、無限に送る。」**
強力な[通常札](../mechanics.md)（例：ユリナの『[![一閃](../assets/images/card/cards/na_01_o_n/na_01_o_n_2.png)](../assets/images/card/cards/na_01_o_n/na_01_o_n_2.png){ .glightbox }』やヒミカの『[![マグナムカノン](../assets/images/card/cards/na_03_o_n/na_03_o_n_3.png)](../assets/images/card/cards/na_03_o_n/na_03_o_n_3.png){ .glightbox }』）をコピーし、毎ターン無償で叩き込み続ける。
...
*   **推奨パートナー**: 有能な[通常札](../mechanics.md)を持つ全メガミ（ユリナ、ヒミカ、ライラ等）
...
ユリナの高い打点をクルルが倍増させる、わかりやすくも強力なペア。
