...
<div class="megami-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
  ...
  <div class="megami-meta">
    <ul>
      ...
      <li><strong>得意[間合](../mechanics/glossary.md)</strong>: 1-10</li>
    </ul>
  </div>
</div>
...
「[機巧](../mechanics/glossary.md)」という力は、彼女がバラバラの事象（カード種別）を緻密に連結させ、巨大な勝利の方程式へと組み上げていく「創造」のプロセスそのものを象徴しています。

## キーワード能力: [機巧](../mechanics/glossary.md) (Kiko / Mechanism)

[クルル](index.md)の強さは、彼女の「持ち物（カード種別）」の多様性に依存します。

*   **[機巧](../mechanics/glossary.md)の発動条件**: 自分の捨て札、使用済みの[切札](../mechanics/glossary.md)、または場にある付与札の中に、指定された**「カード種別（攻撃、行動、付与）」**や**「サブタイプ（対応、全力）」**が存在することで効果が発動します。
*   **戦略的意味**: 手札をただ使うのではなく、「どのカードを先に捨て札に送り、どの[機巧](../mechanics/glossary.md)を起動させるか」という緻密なシーケンス（手順）構築が求められます。

[![---](../assets/images/card/cards/na_14_o_n/na_14_o_n_7.png)](../assets/images/card/cards/na_14_o_n/na_14_o_n_7.png){ .glightbox }

## シーズン10における立ち位置

シーズン10（大[切札](../mechanics/glossary.md)時代）において、[クルル](index.md)は「コンボの頂点」として君臨しています。

*   **大[切札](../mechanics/glossary.md)との親和性**: 相方のメガミが持つ強力な大[切札](../mechanics/glossary.md)をコピーしたり、再利用したりする能力に長けており、環境を定義するような巨大コンボの起点となります。
...
**[![役割](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png)](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png){ .glightbox }**: 主力攻撃 / [機巧](../mechanics/glossary.md)の核

*   **適正[間合](../mechanics/glossary.md)**: 1-10
*   **解説**:
    [機巧](../mechanics/glossary.md)条件を満たすことで、ダメージが跳ね上がる[クルル](index.md)の基本攻撃。[間合](../mechanics/glossary.md)を選ばないため、どんな距離からでも「発明品の雷」を落とすことができます。
...
**[![役割](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png)](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png){ .glightbox }**: 加速 / ドロー

*   **解説**:
    カードを引き、さらに[機巧](../mechanics/glossary.md)条件に応じて追加の行動を可能にする札。[クルル](index.md)の複雑なコンボを回すための重要なピニオンギア（歯車）です。
...
**[![役割](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png)](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png){ .glightbox }**: 再利用 / 回路修復
...
**[![役割](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png)](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png){ .glightbox }**: 範囲攻撃 / 盤面攪乱

*   **解説**:
    広い[間合](../mechanics/glossary.md)をカバーする攻撃。複数の[機巧](../mechanics/glossary.md)を組み合わせることで、相手の[オーラ](../mechanics/glossary.md)をボロボロにする連撃へと昇華します。
...
**[![役割](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png)](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png){ .glightbox }**: リソース回収 / 安定化
...
**[![役割](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png)](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png){ .glightbox }**: モジュール強化 / 付与バフ
...
**[![役割](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png)](../assets/images/card/cards/na_15_o_n/na_15_o_n_7.png){ .glightbox }**: サーチ / 索敵

*   **解説**:
    山札のトップを操作し、必要な[機巧](../mechanics/glossary.md)パーツを確実に手札に呼び込みます。
...
[機巧](../mechanics/glossary.md)条件が累積するほど威力を増し、最終的には[10/10]のような回避不能の致死ダメージを叩き出す巨大ロボット。これを発動させることこそが、多くの[クルル](index.md)使いの至上の喜びです。
...
**解説**:
**「コンボを工場化する」禁断の札。**
相手、あるいは自分の強力な[通常札](../mechanics/glossary.md)をコピーして自分の[切札](../mechanics/glossary.md)のように扱う、あるいは永続的に使用可能にする能力。相方のメガミの最強カードを量産する動きは、対戦相手にとって絶望以外の何物でもありません。
...
**「最強の札を、無限に送る。」**
強力な[通常札](../mechanics/glossary.md)（例：[ユリナ](index.md)の『[![一閃](../assets/images/card/cards/na_01_o_n/na_01_o_n_2.png)](../assets/images/card/cards/na_01_o_n/na_01_o_n_2.png){ .glightbox }』や[ヒミカ](index.md)の『[![マグナムカノン](../assets/images/card/cards/na_03_o_n/na_03_o_n_3.png)](../assets/images/card/cards/na_03_o_n/na_03_o_n_3.png){ .glightbox }』）をコピーし、毎ターン無償で叩き込み続ける。

*   **基本戦術**:
    1. 序盤はコンボ準備に徹し、[切札](../mechanics/glossary.md)のコピー対象を厳選。
    2. 『いんだすとりあ』でコピーを確立。
...
*   **推奨パートナー**: 有能な[通常札](../mechanics/glossary.md)を持つ全メガミ（[ユリナ](index.md)、[ヒミカ](index.md)、[ライラ](index.md)等）

### 2. びっぐごーれむ降臨型 (超火力プラン)
**「パズルを解き、勝利を召喚する。」**
あらゆる[機巧](../mechanics/glossary.md)を総動員して『びっぐごーれむ』のコストと威力をブーストし、一撃で[ライフ](../mechanics/glossary.md)10点を削る。

*   **基本戦術**:
    1. カードを捨て札に計画的に送り、[機巧](../mechanics/glossary.md)条件を網羅する。
    2. [集中力](../mechanics/glossary.md)とドローを管理し、最短でコストを宿す。
...
### [サリヤ](11_sariya.md) (騎絡)
**「変幻自在のモビリティ」**
共にテクニカルな要素（燃料、[機巧](../mechanics/glossary.md)）を持つため、使いこなせば全距離で無双できる。

[![---](../assets/images/card/cards/na_14_o_n/na_14_o_n_7.png)](../assets/images/card/cards/na_14_o_n/na_14_o_n_7.png){ .glightbox }

## 戦術の核心

!!! danger "「[機巧](../mechanics/glossary.md)」の破綻は死を意味する"
    [クルル](index.md)はパズルのピースひとつが欠けただけで、何の効果も持たないメガミに成り下がります。
    **「相手のハンデス（手札破壊）」や「付与札の除去」に対して極めて脆弱です。**
    自分の絡繰を守るための最低限の防御手段を常に意識してください。

!!! tip "「[機巧](../mechanics/glossary.md)」の可視化"
    熟練の[クルル](index.md)使いは、自分の捨て札の構成（攻撃が何枚、行動が何枚……）を完璧に把握しています。
    対戦中は、どの[機巧](../mechanics/glossary.md)が「今」アクティブなのか、どの[機巧](../mechanics/glossary.md)が「次」に必要か、メモを取るような感覚で整理しながら戦いましょう。
