...
**解説**:
**ライラの真の姿。**
一定ターンの間、ゲージの蓄積をさらに加速させ、カードの使用制限を撤廃するなどの「リミッターカット」を行います。この状態のライラは、1ターンに[通常札](../mechanics.md)を何枚も投げつける暴風雨へと変貌します。
...
!!! tip "「[切札](../mechanics.md)」はゲージのためのガソリン"
    ライラにとって、[切札](../mechanics.md)はダメージを与えるだけでなく「ゲージを1（またはそれ以上）上昇させる手段」です。
