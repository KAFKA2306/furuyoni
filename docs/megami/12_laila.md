...
<div class="megami-header" style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
  ...
  <div class="megami-meta">
    - 権能: 爪
    - 難易度: ★★★☆☆
    - 得意[間合](../mechanics/index.md): 0-3
  </div>
</div>

## 本質的な解説

[ライラ](index.md)の本質は「攻撃の積み重ねによる自己進化とボルテージの最大化」にあります。

彼女は最初から最強ではありません。しかし、カードを使うたびに「[帯電](../mechanics/index.md)（ゲージ）」が溜まり、徐々に速度と威力が上昇していきます。中盤以降の[ライラ](index.md)は、もはや通常のゲームルールでは測りきれないほどの連撃を叩き出し、一瞬で[ライフ](../mechanics/index.md)を消し飛ばします。

戦えば戦うほど強くなる、生粋の格闘メガミです。
