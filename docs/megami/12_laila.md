...
ライラの本質は「攻撃の積み重ねによる自己進化とボルテージの最大化」にあります。

彼女は最初から最強ではありません。しかし、カードを使うたびに「帯電（ゲージ）」が溜まり、徐々に速度と威力が上昇していきます。中盤以降のライラは、もはや通常のゲームルールでは測りきれないほどの連撃を叩き出し、一瞬でライフを消し飛ばします。
...
2. 零距離の恐怖: ライラの本領は間合0-2の至近距離にあります。『流転爪』などで強引に距離を詰め、相手に息を吐かせぬ連撃を見舞ってください。
