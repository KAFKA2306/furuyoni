...
!!! info "氷獄の鎖、魂まで凍てつかせる北境の冬"
    コルヌは相手のリソース（[オーラ](../rules.md#aura)や[フレア](../rules.md#flare)）を物理的に「[凍結](../rules.md#freeze)」させ、使用不能にするデバフ特化のコントロールメガミです。
    彼女の最大の特徴は、独自のトークン**「[凍結](../rules.md#freeze)」**を相手の結晶の上に置く能力です。
    凍りついた結晶は、溶けるまで[宿し](../rules.md#yadoshi)や[前進](../rules.md#advance)に使用できず、相手は潤沢な[フレア](../rules.md#flare)を持っていながら[切札](../rules.md)を撃てないという絶望的な状況（ハメ）に陥ります。
...
「[凍結](../rules.md#freeze)」という力は、彼女が相手の選択肢（未来）を一つずつ凍りつかせていき、最終的に世界を真っ白な「永遠の冬」へと塗り替えていく静かな圧力を象徴しています。

## キーワード能力: [凍結](../rules.md#freeze) (Freeze)

コルヌの冷気は、戦場そのものを沈黙させます。

*   **[凍結](../rules.md#freeze)の仕組み**: 相手の[オーラ](../rules.md#aura)や[フレア](../rules.md#flare)にある結晶の上に「[凍結](../rules.md#freeze)トークン」を置きます。
*   **効果の性質**: [凍結](../rules.md#freeze)された結晶は、[基本動作](../rules.md)やカードコストとして支払うことができません。[凍結](../rules.md#freeze)を解除するには、[集中力](../rules.md#focus)を消費したり、特定の行動をとる必要があります。
*   **戦略的意味**: 相手の「次のターンの動き」をピンポイントで予測して凍らせます。例えば、[フレア](../rules.md#flare)を凍らせれば[切札](../rules.md)を封じ、[オーラ](../rules.md#aura)を凍らせれば[前進](../rules.md#advance)を封じることができます。

---

## シーズン10における立ち位置

シーズン10（大[切札](../rules.md)時代）において、コルヌは「沈黙の番人」としての役割を全うしています。

*   **大[切札](../rules.md)へのカウンター**: 大[切札](../rules.md)を撃つためには大量の[フレア](../rules.md#flare)が必要ですが、コルヌはその[フレア](../rules.md#flare)を片端から凍らせていくことで、相手のフィニッシュプランを数ターン遅らせることができます。
*   **近接メタの強化**: [間合](../rules.md#range)1-2での[凍結](../rules.md#freeze)手段が充実しており、接近戦を挑んでくるアグロメガミを文字通り「氷漬け」にして立ち往生させることが可能です。
...
*   **解説**:
    [前進](../rules.md#advance)しながら相手の[間合](../rules.md#range)結晶を凍らせるなど、足元から冷気を浴びせる札。相手は近づくため、あるいは逃げるために余計な労力（[集中力](../rules.md#focus)の消費など）を強いられます。
...
*   **解説**:
    相手の[オーラ](../rules.md#aura)にある複数の結晶を一気に凍らせる補助札。[オーラ](../rules.md#aura)が凍ることで、相手は「[纏い](../rules.md#matoy)」による防御回復ができなくなり、コルヌの攻撃が通りやすい土壌が整います。
...
*   **解説**:
    雪の上を滑るように[間合](../rules.md#range)を変える移動札。自分の有利な距離を維持しながら、ついでに相手を凍らせる、コルヌらしい効率的な動きを支えます。
...
*   **ダメージ**: [3/1] ([凍結](../rules.md#freeze)数によりバフ)
*   **解説**:
    相手が凍れば凍るほど鋭くなる氷の刃。[通常札](../rules.md)でありながら[ライフ](../rules.md#life)を直接削るプレッシャーを与え、相手に「[凍結](../rules.md#freeze)を解除するか、ダメージを受けるか」の選択を迫ります。
...
*   **解説**:
    展開中、相手が[基本動作](../rules.md)を行うたびにペナルティ（さらなる[凍結](../rules.md#freeze)やリソース喪失）を課す付与札。相手を「何もしない方がマシ」という思考停止の状態に追い込みます。
...
*   **解説**:
    鎌による広範囲の薙ぎ払い。[凍結](../rules.md#freeze)で動きが鈍った相手を容赦なく叩き伏せ、[間合](../rules.md#range)を離すための時間を稼ぎます。
...
**解説**:
**この世のすべてを凍りつかせる。**
相手の[オーラ](../rules.md#aura)、[フレア](../rules.md#flare)、[間合](../rules.md#range)にあるすべての結晶を一定期間完全に[凍結](../rules.md#freeze)させる、究極のロックカード。発動した次のターン、相手は文字通り「何もできない」カカシとなります。
...
**解説**:
冷気の壁で身を守る札。
攻撃を無効化しつつ、攻撃してきた相手の手元（[オーラ](../rules.md#aura)）を凍らせる。守りながら攻める、コルヌの神髄です。
...
相手が受けている[凍結](../rules.md#freeze)の数だけ威力を増し、凍りついたままの相手を冷たく葬り去ります。
...
*   **基本戦術**:
    ...
    2. 相手が[凍結](../rules.md#freeze)解除を優先した隙に、メイン火力を叩き込む。
...
### [ウツロ](13_utsuro.md) (鎌鎌)
**「空虚な氷獄」**
[ウツロ](13_utsuro.md)が[オーラ](../rules.md#aura)を[ダスト](../rules.md#dust)へ送り、残った僅かな[オーラ](../rules.md#aura)をコルヌが凍らせる。リソースが完全に消滅する、終焉の組み合わせ。
...
!!! danger "「解凍」という名の逆転"
    相手は[凍結](../rules.md#freeze)を解除するために[集中力](../rules.md#focus)や手札を消費しますが、それは同時に相手に「リソースを綺麗にする（必要な結晶をフリーにする）」機会を与えていることでもあります。
    **「凍らせたから安心」ではなく、凍らせているその数ターンの間に、有効な[ライフ](../rules.md#life)ダメージを与えきることがコルヌの絶対命題です。**

!!! tip "「[フレア](../rules.md#flare)」を優先して凍らせろ"
    [オーラ](../rules.md#aura)を凍らせるのは防御崩しに有効ですが、最も相手の計算を狂わせるのは「[フレア](../rules.md#flare)の[凍結](../rules.md#freeze)」です。
    相手が[切札](../rules.md)を撃とうと[フレア](../rules.md#flare)を5溜めた瞬間に、そのうち2つを凍らせる。
