...
2. 刀扇（[ユリナ](../megami/index.md)／[トコヨ](../megami/index.md)）
   [ユリナ](../megami/index.md)の素直な殴り合い性能に、[トコヨ](../megami/index.md)の「対応（カウンター）や安定性」を足して、攻防バランスを“丸く強く”した型です。相手に合わせて構築を調整しやすく、初心者でも上級者でも握り続けられる基礎体力があります。「困ったら刀扇」になりやすい代表格です。([ふるよにしたいヤシロの書][3])
...
3. 薙扇（[サイネ](../megami/index.md)／[トコヨ](../megami/index.md)）
   防御手段が非常に厚く、条件（[八相](../mechanics/index.md)・[境地](../mechanics/index.md)）を満たすと攻防が高水準にまとまり、対応札の多さで相手にケアを強制する“万能コントロール寄り”です。回れば多くの相手に互角以上を取りやすい反面、条件管理の精度が要求され、プレイが雑だとただ遅いデッキになりがちです。([Hikari Fryn][4])
...
4. 銃扇（[ヒミカ](../megami/index.md)／[トコヨ](../megami/index.md)）
   序盤の[連火](../mechanics/index.md)を絡めた攻め（[ヒミカ](../megami/index.md)）と、近中距離のコントロールや遠距離の[切札](../mechanics/index.md)圧（[トコヨ](../megami/index.md)）を両立し、「近くも遠くもやれる」せいで相手の対策方針を迷わせる型です。強い出し方は“どちらかに寄せて尖らせる”ことで、バランス取り過ぎると決め手が薄くなります。([Hikari Fryn][5])
...
5. 薙銃（[サイネ](../megami/index.md)／[ヒミカ](../megami/index.md)）
   「遠距離レンジロック」「[後退](../mechanics/index.md)しながらの攻撃」「[連火](../mechanics/index.md)の打点ブースト」などで、1巡目と中盤以降に“まとまった攻撃の波”を2回作って勝つプランが代表的です。相手は距離と受けの両方にケアが必要で、ミスると一気に[ライフ](../mechanics/index.md)が溶けます。([Hikari Fryn][6])
...
6. 刀忍（[ユリナ](../megami/index.md)／[オボロ](../megami/index.md)）
   近距離（特に[間合](../mechanics/index.md)2付近）でのビートダウンが極めて強く、[オボロ](../megami/index.md)の[設置](../mechanics/index.md)で利得を稼ぎつつ、[ユリナ](../megami/index.md)の[切札](../mechanics/index.md)で決め切る“シンプルでパワフル”な型です。弱点は極端で、遠距離レンジロックやクリンチ（[間合](../mechanics/index.md)0に押し込む）に寄せられると攻撃が振れなくなりやすいです。([Hikari Fryn][7])
...
7. 忍傘（[オボロ](../megami/index.md)／[ユキヒ](../megami/index.md)）
   [設置](../mechanics/index.md)で利得を稼ぐ[オボロ](../megami/index.md)と、傘の[開閉](../mechanics/index.md)で得意[間合](../mechanics/index.md)が変わる[ユキヒ](../megami/index.md)を合わせ、クロック的に削りながら終盤にリーサルを作る型が有名です。特定対面（レンジロック相手など）への回答として刺さりやすく、回り始めると相手が追いつけない展開になりますが、ループが止まる条件（大きい被弾、[後退](../mechanics/index.md)不能など）を踏むと一気に破綻します。([Hikari Fryn][8])
...
8. 「書」[シンラ](../megami/index.md)系（例：薙書＝[サイネ](../megami/index.md)／[シンラ](../megami/index.md)、ほか[シンラ](../megami/index.md)核）
   [シンラ](../megami/index.md)は「相手のデッキギミック破壊」「悠長なプランの否定」「レンジロック補助・対抗」など、“ふるよにの基本構造から外れた勝ち筋”を取り締まるのが強みで、相方の火力補助やサブ火力も担えます。薙書のように、相方でビートもコントロールもカバーできる組み合わせはデッキタイプの射程が広く、対面適応力が高いのが売りです。([へくとぱ雑文投棄所][9])
