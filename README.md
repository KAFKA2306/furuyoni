...
このサイトは、『桜降る代に決闘を 再演』の現行情報と『新幕 桜降る代に決闘を』シーズン1〜10の蓄積を、版を混同せずに調べるための非公式資料です。版・フォーマット・資料索引・機械可読オントロジーなどの技術的な整理は、その問題を理解した後で使います。

READMEの入口は [`KAFKA2306/articles#34`](https://github.com/KAFKA2306/articles/issues/34) の「広い問題 → 具体例 → 技術」の編集原則を維持します。現行公式、過去の公式、非公式解説、検証待ちを分離し、現行裁定には現行公式を優先します。
